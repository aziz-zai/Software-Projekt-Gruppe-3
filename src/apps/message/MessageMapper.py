...
class MessageMapper (Mapper):
    ...
    def find_by_Message_id(self, owner_id):
    ...
    def insert(self, account):
        ...
        data = (Message.get_id(), Message.get_owner())
    ...
    def update(self, account):
        ...
        data = (Message.get_owner(), Message.get_id())
        cursor.execute(command, data)
    ...
    def delete(self, account):
        ...
        command = "DELETE FROM accounts WHERE id={}".format(Message.get_id())
        cursor.execute(command)
